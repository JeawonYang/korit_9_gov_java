...
public class BoradMain {
    public static void main(String[] args) {
        ...
        l1.get(0).put("writer", "김준삼");
        l1.get(0).put("content", "댓글 내용2");
        ...
        ((ArrayList<HashMap <String, String>>) boardMap1.get("comments")).get(0).put("comment","댓글 내용1");
        ((ArrayList<HashMap <String, String>>) boardMap1.get("comments")).get(1).put("writer", "김준삼");
        ((ArrayList<HashMap <String, String>>) boardMap1.get("comments")).get(1).put("comment", "댓글 내용2");
        ...
        ((ArrayList<HashMap <String, String>>) boardMap2.get("comments")).get(0).put("comment","댓글 내용11");
        ((ArrayList<HashMap <String, String>>) boardMap2.get("comments")).get(1).put("writer", "김준육");
        ((ArrayList<HashMap <String, String>>) boardMap2.get("comments")).get(1).put("comment", "댓글 내용22");
