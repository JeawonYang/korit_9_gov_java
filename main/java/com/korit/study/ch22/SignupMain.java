        ...
        while (true) {
            ...
            if("q".equalsIgnoreCase(selectedMenu)) {
                ...
                while (true) {
                    ...
                    signupDto.setUsername(sc.nextLine());
                ...
                while (true) {
                    ...
                    signupDto.setPassword(sc.nextLine());
                    if (signupService.isValidDuplicatedUsername(signupDto.getPassword())) {
                        break;
                    }
                ...
                while (true) {
                    ...
                    signupDto.setComfirmPassword(sc.nextLine());
