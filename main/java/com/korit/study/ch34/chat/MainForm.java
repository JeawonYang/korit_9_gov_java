    ...
    class CenterPanel extends JPanel {
        ...
        public CenterPanel(LayoutManager layout) {
            ...
            Thread messageReceiver = new Thread(() -> {
                try {
                    BufferedReader in = new BufferedReader(new InputStreamReader(com.korit.study.ch34.chat.Main.socket.getInputStream()));
                    while (true) {
        ...
        public BottomPanel(LayoutManager layout) {
            ...
            sendButton.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    try {
                        PrintWriter out = new PrintWriter(com.korit.study.ch34.chat.Main.socket.getOutputStream());
